...
{\normalsize  \textbf{Temas:}  Espacio Muestral, Propiedades de la \mbox{Funci\'on} Probabilidad, Probabilidad Condicional, Teorema  de Bayes, Teorema de la Probabilidad Total, Variables Aleatorias : Discretas y Continuas.}
